    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-brand-deep font-sans p-4 relative overflow-hidden text-white">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_15px_45px_rgba(0,0,0,0.15)] p-8 md:p-10 border border-slate-200 backdrop-blur-sm relative z-10 text-slate-800">
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <a href="#" className="text-xs font-semibold text-brand-teal hover:text-brand-deep transition-colors">
                Forgot Password?
              </a>
            </div>
            <input 
          ...
          <button className="w-full bg-brand-teal hover:bg-brand-deep text-white font-bold py-3.5 rounded-xl transition-all mt-2 shadow-md hover:shadow-lg active:scale-[0.98]">
            Sign In
          </button>
        ...
        <p className="text-center text-sm text-slate-900 mt-8">
          Don't have an account? <Link href="/register" className="font-bold text-brand-teal hover:text-brand-deep transition-colors">Register here</Link>
        </p>
      </div>
    </div>
  );
